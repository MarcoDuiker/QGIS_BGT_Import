...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="1e+08" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2ace5827-b8a1-4384-959e-582f908d8047}">
      <rule symbol="0" key="{3f99a3cf-1f0a-48aa-a623-eb77b846d63c}" label="Kademuur" filter="&quot;bgt-type&quot; = 'kademuur'"/>
      <rule symbol="1" key="{a40c4336-9738-4616-8cf4-9db7292b744c}" label="Muur" filter="&quot;bgt-type&quot; = 'muur'"/>
      <rule symbol="2" key="{60312bab-bfa6-4a10-be24-6150956d95b5}" label="Transitie" filter="&quot;bgt-type&quot; = 'transitie'"/>
    </rules>
    <symbols>
