...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="1e+08" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{77aa39c1-dd5f-41bd-877d-566ee2781d40}">
      <rule symbol="0" key="{d6981136-ebd8-480b-a311-c6286f796692}" label="Pand: 0-1000" scalemaxdenom="1000"/>
      <rule symbol="1" key="{a63f14a7-ed3d-4ac2-a1c4-c4f4f0c7664a}" label="Pand: 1000-2500" scalemindenom="1001" scalemaxdenom="2500"/>
      <rule symbol="2" key="{da6d5a99-1ecc-4225-81e9-190fa9b53253}" label="Pand: 2500-" scalemindenom="2501"/>
    </rules>
    <symbols>
