...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="5000" simplifyDrawingHints="1">
  ...
  <fieldConfiguration>
    ...
    <field name="hoortBijTypeOverbrugging">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="overbruggingIsBeweegbaar">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="12" name="" field="class"/>
    <alias index="13" name="" field="hoortBijTypeOverbrugging"/>
    <alias index="14" name="" field="overbruggingIsBeweegbaar"/>
    <alias index="15" name="" field="terminationDate"/>
    <alias index="16" name="" field="eindRegistratie"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="hoortBijTypeOverbrugging" applyOnUpdate="0"/>
    <default expression="" field="overbruggingIsBeweegbaar" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="class"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="hoortBijTypeOverbrugging"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="overbruggingIsBeweegbaar"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="hoortBijTypeOverbrugging" desc=""/>
    <constraint exp="" field="overbruggingIsBeweegbaar" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="hoortBijTypeOverbrugging" hidden="0"/>
      <column width="-1" type="field" name="overbruggingIsBeweegbaar" hidden="0"/>
