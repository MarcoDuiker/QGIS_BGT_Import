...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="1e+08" simplifyDrawingHints="0">
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e33f48da-9867-4c9d-94db-67b98aeadbaa}">
      <rule symbol="0" key="{c811c52b-3a0b-40a4-941b-da70447d6cef}" label="Hoogspanningsmast" filter="&quot;bgt-type&quot; = 'hoogspanningsmast'" scalemaxdenom="1000"/>
      <rule symbol="1" key="{209fa57b-6938-4990-a56e-42f1b270cbe1}" label="Hoogspanningsmast" filter="&quot;bgt-type&quot; = 'hoogspanningsmast'" scalemindenom="1001" scalemaxdenom="5000"/>
      <rule symbol="2" key="{4e383243-3390-40f4-8691-47de90a789ca}" label="Transitie" filter="&quot;bgt-type&quot; = 'transitie'" scalemaxdenom="1000"/>
      <rule symbol="3" key="{c61bf382-06ea-4c85-a924-0f525b2e2730}" label="Transitie" filter="&quot;bgt-type&quot; = 'transitie'" scalemindenom="1001" scalemaxdenom="5000"/>
    </rules>
    <symbols>
