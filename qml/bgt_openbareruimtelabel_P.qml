...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="1" readOnly="0" minScale="2500" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings>
      <text-style fontItalic="0" textOpacity="1" fontUnderline="0" fontStrikeout="0" fontLetterSpacing="0" namedStyle="Normal" fieldName="tekst" fontSize="6" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" multilineHeight="1" fontWeight="50" fontCapitals="0" fontSizeUnit="Point" blendMode="0" isExpression="0" fontFamily="Sans Serif" useSubstitutions="0" previewBkgrdColor="#ffffff" textColor="0,0,0,255">
        <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferOpacity="0.736" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSize="1"/>
      ...
      <rendering obstacle="0" maxNumLabels="2000" obstacleType="0" fontLimitPixelSize="0" displayAll="0" obstacleFactor="1" minFeatureSize="0" fontMaxPixelSize="10000" drawLabels="1" scaleVisibility="0" limitNumLabels="0" upsidedownLabels="1" labelPerPart="1" mergeLines="0" scaleMax="0" scaleMin="0" fontMinPixelSize="3" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field name="identificatieBAGOPR">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="12" name="" field="identificatieBAGOPR"/>
    <alias index="13" name="" field="tekst"/>
    <alias index="14" name="" field="hoek"/>
    <alias index="15" name="" field="openbareRuimteType"/>
    <alias index="16" name="" field="terminationDate"/>
    <alias index="17" name="" field="eindRegistratie"/>
    <alias index="18" name="" field="test"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="identificatieBAGOPR" applyOnUpdate="0"/>
    <default expression="" field="tekst" applyOnUpdate="0"/>
    <default expression="" field="hoek" applyOnUpdate="0"/>
    <default expression="" field="openbareRuimteType" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="identificatieBAGOPR"/>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="openbareRuimteType"/>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="test"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="identificatieBAGOPR" desc=""/>
    <constraint exp="" field="tekst" desc=""/>
    <constraint exp="" field="hoek" desc=""/>
    <constraint exp="" field="openbareRuimteType" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;test&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="identificatieBAGOPR" hidden="0"/>
      <column width="273" type="field" name="tekst" hidden="0"/>
      <column width="309" type="field" name="hoek" hidden="0"/>
      <column width="295" type="field" name="openbareRuimteType" hidden="0"/>
      <column width="-1" type="field" name="terminationDate" hidden="0"/>
      <column width="-1" type="field" name="eindRegistratie" hidden="0"/>
      <column width="-1" type="actions" hidden="1"/>
      <column width="-1" type="field" name="test" hidden="1"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <expressionfields>
    <field subType="0" expression="to_real( array_to_string( array_slice( string_to_array(&quot;hoek&quot;),1,2)))" type="6" name="test" precision="0" comment="" typeName="double" length="0"/>
    <field subType="0" expression=" regexp_substr(  &quot;hoek&quot;  , '[:](\\d*)[,]*')" type="6" name="test" precision="0" comment="" typeName="double" length="0"/>
    <field subType="0" expression="  to_real( regexp_substr(  &quot;hoek&quot;  , '[:](\\d*)[,]*'))" type="6" name="test" precision="0" comment="" typeName="double" length="0"/>
  </expressionfields>
