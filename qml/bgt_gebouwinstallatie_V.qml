...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="1e+08" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{baff5b11-5cff-46e7-b71f-27e880d611f4}">
      <rule symbol="0" key="{d498a1fe-838f-4257-98c1-27a92bb6bbed}" label="Bordes" filter="&quot;plus-typeGebouwInstallatie&quot; = 'bordes'"/>
      <rule symbol="1" key="{8d3dbb19-039d-4c17-9d33-0b8e8bbea68e}" label="Luifel" filter="&quot;plus-typeGebouwInstallatie&quot; = 'luifel'"/>
      <rule symbol="2" key="{9b7ed668-30fa-4361-9327-7a9e31846bf2}" label="Toegangstrap" filter="&quot;plus-typeGebouwInstallatie&quot; = 'toegangstrap'"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" type="fill" name="2" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="Pixel"/>
          <prop k="outline_color" v="215,57,57,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="1"/>
          <prop k="outline_width_unit" v="Pixel"/>
          <prop k="style" v="solid"/>
  ...
  <fieldConfiguration>
    ...
    <field name="plus-typeGebouwInstallatie">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="13" name="" field="plus-typeGebouwInstallatie"/>
  ...
  <defaults>
    ...
    <default expression="" field="plus-typeGebouwInstallatie" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="plus-typeGebouwInstallatie"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="plus-typeGebouwInstallatie" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="316" type="field" name="plus-typeGebouwInstallatie" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="plus-typeGebouwInstallatie" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="plus-typeGebouwInstallatie"/>
