...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.2.3-Bonn" labelsEnabled="0" readOnly="0" minScale="1e+08" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{98905e0b-c023-4698-acab-f1007f797184}">
      <rule symbol="0" key="{4a16b90f-9fbd-4dea-9dd5-62b6754b0ed3}" label="Stuw" filter="&quot;bgt-type&quot; = 'stuw'" scalemaxdenom="5000"/>
      <rule symbol="1" key="{63ed0636-fb51-44bc-8193-8113c120cf2c}" label="Duiker" filter="&quot;plus-type&quot; = 'duiker'" scalemaxdenom="5000"/>
      <rule symbol="2" key="{72e06216-7b00-48d7-992c-e84da3bcc965}" label="Transitie" filter="&quot;bgt-type&quot; = 'transitie'" scalemaxdenom="5000"/>
    </rules>
    <symbols>
  ...
  <DiagramLayerSettings dist="0" obstacle="0" zIndex="0" linePlacementFlags="18" placement="2" priority="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
